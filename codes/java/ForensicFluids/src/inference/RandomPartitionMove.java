...
public class RandomPartitionMove {
    public static double randomPartition(ArrayList<Integer>[] subtypesList){
        ...
        ArrayList<Integer>[][] allParts = MathUtils.getCluster("/Users/chwu/Documents/research/bfc/github/Forensic-Fluids/output/allPartitionSets3.txt", 5);
        int propPartIndex = random.nextInt(5);
