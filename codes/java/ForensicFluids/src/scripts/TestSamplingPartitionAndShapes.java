...
public class TestSamplingPartitionAndShapes {
    ...
    private void runEx7ObsShape1(String allPartitionSets5File,
        ...
        Parameter shapeB = new Parameter("shape.b", new double[]{2.0, 2.0, 0.25, 2.0, 2.0}, 0);
        ...
        String outputFilePath = "/Users/chwu/Documents/research/bfc/output/2022_07_15/test_slv_single_7obs_part_shapeA_2022_07_15_v2.log";
        MCMC estSubtype = new MCMC(probs, proposalMoves, null, states, 10000, 100, outputFilePath);
        estSubtype.run();
