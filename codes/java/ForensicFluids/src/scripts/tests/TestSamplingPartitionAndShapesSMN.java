...
public class TestSamplingPartitionAndShapesSMN {

    public static final int[][] COL_RANGE = {{0, 4}, {5, 11}, {12, 16}, {17, 21}, {22, 26}};

    public static void main(String[] args){

        TestSamplingPartitionAndShapesSMN mcmcPrior = new TestSamplingPartitionAndShapesSMN();
        try {
    ...
    private void runEx7ObsShape1(String allPartitionSets5File,
        ...
        String outputFilePath = "/Users/chwu/Documents/research/bfc/output/2022_09_16/test_smn_single_estBetaShapes_2022_09_16.log";
