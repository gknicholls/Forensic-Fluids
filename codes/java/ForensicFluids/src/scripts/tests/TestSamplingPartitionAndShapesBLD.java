...
public class TestSamplingPartitionAndShapesBLD {

    public static final int[][] COL_RANGE = {{0, 4}, {5, 11}, {12, 16}, {17, 21}, {22, 26}};

    public static void main(String[] args){

        TestSamplingPartitionAndShapesBLD mcmcPrior = new TestSamplingPartitionAndShapesBLD();
        try {
    ...
    private void runEx7ObsShape1(String allPartitionSets5File,
        ...
        String dataFilePath = "/Users/chwu/Documents/research/bfc/github/Forensic-Fluids/data/bld.single.csv";
        ...
        String outputFilePath = "/Users/chwu/Documents/research/bfc/output/2022_09_16/test_bld_single_estBetaShapes_2022_09_16.log";
