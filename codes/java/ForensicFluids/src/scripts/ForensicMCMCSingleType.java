...
public class ForensicMCMCSingleType {
    public static void main(String[] args){
        ...
        ForensicMCMCSingleType smnSubtypes = new ForensicMCMCSingleType();
        smnSubtypes.runSmnSingleTypeClustering();
    }

    private void runBldSingleTypeClustering(){

    }

    private void runSmnSingleTypeClustering(){
