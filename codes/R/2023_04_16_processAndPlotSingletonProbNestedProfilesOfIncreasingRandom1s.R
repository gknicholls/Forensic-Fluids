...
random1_0.5_cut_side.df = read.table(file = "/Users/chwu/Documents/research/bfc/analysis/2023_04_16/random1_0.5_cut_side.log",
                                     header = T, as.is = T, sep ="\t")
random1_0.5_cut_side.df = random1_0.5_cut_side.df[-c(1:ceiling(nrow(random1_0.5_cut_side.df))/10 ),]

random1_0.6_cut_side.df = read.table(file = "/Users/chwu/Documents/research/bfc/analysis/2023_04_16/random1_0.6_cut_side.log",
                                     header = T, as.is = T, sep ="\t")
random1_0.6_cut_side.df = random1_0.6_cut_side.df[-c(1:ceiling(nrow(random1_0.6_cut_side.df))/10 ),]

random1_0.7_cut_side.df = read.table(file = "/Users/chwu/Documents/research/bfc/analysis/2023_04_16/random1_0.7_cut_side.log",
                                     header = T, as.is = T, sep ="\t")
random1_0.7_cut_side.df = random1_0.7_cut_side.df[-c(1:ceiling(nrow(random1_0.7_cut_side.df))/10 ),]


random1_0.8_cut_side.df = read.table(file = "/Users/chwu/Documents/research/bfc/analysis/2023_04_16/random1_0.8_cut_side.log",
                                     header = T, as.is = T, sep ="\t")
random1_0.8_cut_side.df = random1_0.8_cut_side.df[-c(1:ceiling(nrow(random1_0.8_cut_side.df))/10 ),]

random1_0.9_cut_side.df = read.table(file = "/Users/chwu/Documents/research/bfc/analysis/2023_04_16/random1_0.9_cut_side.log",
                                     header = T, as.is = T, sep ="\t")
random1_0.9_cut_side.df = random1_0.9_cut_side.df[-c(1:ceiling(nrow(random1_0.9_cut_side.df))/10 ),]

random1_1.0_cut_side.df = read.table(file = "/Users/chwu/Documents/research/bfc/analysis/2023_04_16/random1_1.0_cut_side.log",
                                     header = T, as.is = T, sep ="\t")
...
obs322SingletonProbs = unlist(lapply(random1CutSingletonPostProbsList, function(z){return(z[322])}))
pdf(file = "/Users/chwu/Documents/research/bfc/plots/2023_04_16/posteriorSingletonProbability.pdf",
    height = 7.5, width = 6)
...
for(aIndex in 1:length(random1CutSideList)){
  ...
  plot(x = c(1, 322), range(random1CutSingletonPostProbsList[[aIndex]]), type = "n", ylim = c(0,1),
       xlab = "Obs. index", ylab = "Posterior singleton probability",
       main = paste("Proportion of 1's in random profile:", c(4 + aIndex)/10))
  ...
  text(x = 10, y = 0.8, label = paste("Pr(Random profile\n      is singleton) = ", signif(obs322SingletonProbs[aIndex], 3), sep=""), pos = 4)
}
dev.off()
