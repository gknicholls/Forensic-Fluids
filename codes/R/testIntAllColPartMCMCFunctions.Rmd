...
ex.subtype.log.lik.expt = sum(ex.subtype.log.lik.expt)
...
ex.subtype.log.lik.ans = calcLogTypeLik(eltsAllPartSetList = list(elts3AllPartSet,
                                              elts4AllPartSet), 
                          eltsAllPartSetPriorList = list(elts3AllPartSetMDPPrior,
                                                   elts4AllPartSetMDPPrior), 
                          sample = cbind(slvEx1.df, 
                                   slvEx2.df), 
...
subtype_lik_test1[partIndex] = checkAbsDiff(expected = ex.subtype.log.lik.expt, 
                                            answer = ex.subtype.log.lik.ans,
                                            print = FALSE)
subtype_lik_test2[partIndex] = checkAbsRelativeDiff(expected = ex.subtype.log.lik.expt,
                     answer = ex.subtype.log.lik.ans, 
                     rel = min(abs(c(ex.subtype.log.lik.expt, 
                                     ex.subtype.log.lik.ans))),
                                            print = FALSE)
