...
ex1.expt1 = sum(log(1:9)) - sum(log(25:34)) - (sum(log(2)) - sum(log(1:4)))
...
ex1.expt2 = (sum(log(1:4)) - sum(log(20:24))) + (sum(log(1:6)) - sum(log(8:14))) - 2*(sum(log(2)) - sum(log(1:4)))
...
ex1.expt3 = ((sum(log(1:7)) - sum(log(17:24)))) + 
  ((sum(log(1:3)) - sum(log(11:14)))) - 2*(sum(log(2)) - sum(log(1:4)))
...
ex1.expt4 = -sum(log(c(6, 13, 14))) + 
  ((sum(log(1:8)) - sum(log(16:24)))) - 2*(sum(log(2)) - sum(log(1:4)))
...
ex1.expt5 = (-sum(log(c(6, 13, 14)))) + 
  ...
  (sum(log(1:6)) - sum(log(c(8:14)))) - 3*(sum(log(2)) - sum(log(1:4)))
...
ex2.expt1 = sum(log(1:13)) - sum(log(31:44)) + sum(log(1:4)) - log(2)
...
ex2.expt2.clust1.log.lik = sum(log(1:12)) - sum(log(22:34)) + 2*(sum(log(1:4)) - log(2))
...
ex2.expt3.clust1.log.lik = sum(log(1:5)) - sum(log(29:34)) + 2*(sum(log(1:4)) - log(2))
...
ex2.expt4 = ex2.expt4.clust1.log.lik + ex2.expt4.clust2.log.lik + 2*(sum(log(1:4)) - log(2))
